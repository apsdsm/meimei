...
nova-public1-chatbot on nova-public1 (public1)
  chatbot  nova-chatbot:bootstrap → nova-chatbot:sha-7c624c5
  registered nova-public1-chatbot:19
...
chatbot: CannotPullImageManifestError: Error response from daemon:
...
error: nova-chatbot:sha-7c624c5 is not in ECR (123456789012, ap-northeast-1)

  build and push it first:
      meimei build chatbot --push

  or promote a tag that exists:
      meimei deploy chatbot --tag sha-a84bc2f      (pushed 2026-08-20 05:37)
