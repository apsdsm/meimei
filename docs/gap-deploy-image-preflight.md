...
```
Error: 2 images are not in ECR (036558358799, ap-northeast-1):

  jjc2-api:rel-doesnotexist99
  jjc2-sysadmin-web-spa:rel-doesnotexist99
...
```
Error: jjc2-api:jjc2.20260820.001 is one of several tags on the same image (also: bootstrap)
...
```
  api  jjc2-api:bootstrap → jjc2-api:rel-9f2c1a7b0e44
