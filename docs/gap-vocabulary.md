...
environment to `nova_chatbot` and failing to describe the problem in meimei's own words.
...
|---|---|---|
| ECS cluster | `nova-public1` | **config** — `[[targets]].cluster` |
| ECS service | `nova-public1-chatbot` | *inferred* |
| task definition family | `nova-public1-chatbot` | *inferred, assumed equal to the service* |
| task definition revision | `nova-public1-chatbot:7` | created by the deploy |
